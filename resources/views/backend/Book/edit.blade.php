    ...
    <div class="card border-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control @error('photo') is-invalid @enderror" onchange="document.querySelector('#photo').src=window.URL.createObjectURL(this.files[0])"  name="photo" id=".jpg,.png,.jpeg"/>
                @error('photo')
                <div class="text text-danger">{{ $message }}</div>
            @enderror
            <img src="{{asset('/storage/'.$book->photo)}}" class="img-fluid mt-4" height="200" width="200" id="photo" alt="Luna John" >
